.class public final Landroid/support/v4/app/cx;
...
.method public constructor <init>(Landroid/content/Context;Landroid/app/Notification;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/widget/RemoteViews;ILandroid/app/PendingIntent;Landroid/app/PendingIntent;Landroid/graphics/Bitmap;IIZZILjava/lang/CharSequence;ZLandroid/os/Bundle;Ljava/lang/String;ZLjava/lang/String;)V
    ...
    iput-object v4, p0, Landroid/support/v4/app/cx;->c:Ljava/util/List;
    ...
    iput-object v4, p0, Landroid/support/v4/app/cx;->a:Landroid/app/Notification$Builder;
    ...
    iput-object v4, p0, Landroid/support/v4/app/cx;->b:Landroid/os/Bundle;

    .line 4084
    if-eqz p18, :cond_0

    .line 4085
    iget-object v4, p0, Landroid/support/v4/app/cx;->b:Landroid/os/Bundle;
...
.method public final a()Landroid/app/Notification$Builder;
    ...
    .prologue
    .line 4097
    iget-object v0, p0, Landroid/support/v4/app/cx;->a:Landroid/app/Notification$Builder;
...
.method public final a(Landroid/support/v4/app/bn;)V
    ...
    .prologue
    .line 4098
    iget-object v0, p0, Landroid/support/v4/app/cx;->c:Ljava/util/List;

    iget-object v1, p0, Landroid/support/v4/app/cx;->a:Landroid/app/Notification$Builder;

    invoke-static {v1, p1}, Landroid/support/v4/app/cy;->a(Landroid/app/Notification$Builder;Landroid/support/v4/app/bn;)Landroid/os/Bundle;
...
.method public final b()Landroid/app/Notification;
    ...
    .line 4101
    invoke-static {v1}, Landroid/support/v4/app/cy;->a(Landroid/app/Notification;)Landroid/os/Bundle;
    ...
    iget-object v0, p0, Landroid/support/v4/app/cx;->b:Landroid/os/Bundle;
    ...
    invoke-static {v0}, Landroid/support/v4/app/cy;->a(Ljava/util/List;)Landroid/util/SparseArray;
