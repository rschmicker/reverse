...
.method public final a(Landroid/support/v4/app/cd;)Landroid/app/Notification;
    ...
    .prologue
    .line 3869
    iget-object v0, p1, Landroid/support/v4/app/cd;->a:Landroid/content/Context;

    iget-object v1, p1, Landroid/support/v4/app/cd;->B:Landroid/app/Notification;
    ...
    iget-object v4, p1, Landroid/support/v4/app/cd;->h:Ljava/lang/CharSequence;

    iget-object v5, p1, Landroid/support/v4/app/cd;->f:Landroid/widget/RemoteViews;

    iget v6, p1, Landroid/support/v4/app/cd;->i:I

    iget-object v7, p1, Landroid/support/v4/app/cd;->d:Landroid/app/PendingIntent;

    iget-object v8, p1, Landroid/support/v4/app/cd;->e:Landroid/app/PendingIntent;

    iget-object v9, p1, Landroid/support/v4/app/cd;->g:Landroid/graphics/Bitmap;
